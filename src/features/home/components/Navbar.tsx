          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-blue-400">TeamTrack</span>
              </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button className="relative p-2 text-gray-400 hover:bg-blue-800 rounded-lg transition-colors">
              ...
              <div className="relative group">
                <button className="flex items-center space-x-2 p-2 hover:bg-blue-800 rounded-lg transition-colors">
                  <div className="w-8 h-8 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center">
                    <FaUser className="w-5 h-5 text-white" />
                  </div>
                  <span className="text-sm font-medium text-gray-200">Admin</span>
                </button>
                <div className="absolute bottom-[-35px] left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity text-xs bg-gray-700 text-white px-3 py-1 rounded shadow-lg z-10">
                  Profile Settings
                </div>
              </div>
            </div>
